...
public class UserRepositoryImpl implements UserRepository {
    ...
    private static final String SQL_CREATE = "INSERT INTO SB_USERS(USER_ID, FIRST_NAME, LAST_NAME, EMAIL," +
            "PASSWORD) VALUES(NEXTVAL('SB_USERS_SEQ'), ?, ?, ?, ?)";
